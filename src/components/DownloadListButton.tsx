...
export function DownloadListButton({ rows, filename }: { rows: Row[]; filename: string }) {
  ...
  return (
    <button
      ...
      className="inline-flex items-center gap-1.5 rounded-lg border border-zinc-300 bg-white px-3 py-1.5 text-sm font-medium text-zinc-700 hover:bg-zinc-50 disabled:cursor-not-allowed disabled:opacity-50"
    >
